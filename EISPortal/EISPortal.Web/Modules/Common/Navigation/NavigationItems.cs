...
using Northwind = EISPortal.Northwind.Pages;
using Administration = EISPortal.Administration.Pages;
using Basic = EISPortal.BasicSamples.Pages;

[assembly: NavigationLink(1000, "Dashboard", url: "~/", permission: "", icon: "icon-speedometer")]

[assembly: NavigationMenu(2000, "Review", icon: "fa-history")]
[assembly: NavigationLink(2100, "Review/主管週會", typeof(Northwind.CustomerController), icon: "icon-wallet")]

[assembly: NavigationLink(3000, "Resale", typeof(Northwind.CustomerController), icon: "fa-line-chart")]

[assembly: NavigationMenu(4000, "Forecast", icon: "fa-rocket")]
[assembly: NavigationLink(4100, "Forecast/未來四個月", typeof(Northwind.CustomerController), icon: "icon-wallet")]

[assembly: NavigationLink(5000, "Purchase Order", typeof(Northwind.CustomerController), icon: "fa-cart-plus")]

[assembly: NavigationMenu(6000, "Inventory", icon: "fa-cubes")]
[assembly: NavigationLink(6100, "Inventory/庫存", typeof(Northwind.CustomerController), icon: "icon-wallet")]

[assembly: NavigationLink(6500, "Customer Order", typeof(Northwind.CustomerController), icon: "fa-random")]

...
(function (EISPortal) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return EISPortal.LanguageList.getValue();
            };
    ...
    })(Northwind = EISPortal.Northwind || (EISPortal.Northwind = {}));
})(EISPortal || (EISPortal = {}));
var EISPortal;
(function (EISPortal) {
    var Northwind;
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(EISPortal.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(EISPortal.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (EISPortal) {
    ...
    })(Common = EISPortal.Common || (EISPortal.Common = {}));
})(EISPortal || (EISPortal = {}));
...
(function (EISPortal) {
    ...
    (function (Northwind) {
        ...
        }(EISPortal.Common.GridEditorDialog));
...
(function (EISPortal) {
    ...
    (function (Northwind) {
        ...
        }(EISPortal.Common.GridEditorBase));
    ...
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new EISPortal.BasicProgressDialog();
...
(function (EISPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(EISPortal.Common.BulkServiceAction));
        BasicSamples.OrderBulkAction = OrderBulkAction;
    })(BasicSamples = EISPortal.BasicSamples || (EISPortal.BasicSamples = {}));
})(EISPortal || (EISPortal = {}));
var EISPortal;
(function (EISPortal) {
    var Northwind;
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(EISPortal.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: EISPortal.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                EISPortal.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
...
(function (EISPortal) {
    ...
    })(Membership = EISPortal.Membership || (EISPortal.Membership = {}));
})(EISPortal || (EISPortal = {}));
var EISPortal;
(function (EISPortal) {
    var Membership;
...
(function (EISPortal) {
    ...
    })(ScriptInitialization = EISPortal.ScriptInitialization || (EISPortal.ScriptInitialization = {}));
})(EISPortal || (EISPortal = {}));
var EISPortal;
(function (EISPortal) {
    var Common;
...
(function (EISPortal) {
    ...
    })(Administration = EISPortal.Administration || (EISPortal.Administration = {}));
})(EISPortal || (EISPortal = {}));
var EISPortal;
(function (EISPortal) {
    var Administration;
...
(function (EISPortal) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return EISPortal.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = EISPortal.BasicSamples || (EISPortal.BasicSamples = {}));
})(EISPortal || (EISPortal = {}));
var EISPortal;
(function (EISPortal) {
...
(function (EISPortal) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'EISPortal.Northwind.Entities.Gender');
    })(Northwind = EISPortal.Northwind || (EISPortal.Northwind = {}));
})(EISPortal || (EISPortal = {}));
var EISPortal;
(function (EISPortal) {
...
(function (EISPortal) {
    ...
    EISPortal.BasicProgressDialog = BasicProgressDialog;
})(EISPortal || (EISPortal = {}));
var EISPortal;
(function (EISPortal) {
    var DialogUtils;
    ...
    })(DialogUtils = EISPortal.DialogUtils || (EISPortal.DialogUtils = {}));
})(EISPortal || (EISPortal = {}));
var EISPortal;
(function (EISPortal) {
    var Common;
...
(function (EISPortal) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = EISPortal.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = EISPortal.LanguageList || (EISPortal.LanguageList = {}));
})(EISPortal || (EISPortal = {}));
var EISPortal;
(function (EISPortal) {
    var Common;
...
(function (EISPortal) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return EISPortal.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return EISPortal.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return EISPortal.Northwind.SalesByCategoryService.baseUrl; };
            /**
...
(function (EISPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(EISPortal.Northwind.ProductGrid));
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = EISPortal.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(EISPortal.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new EISPortal.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new EISPortal.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new EISPortal.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, EISPortal.Northwind.OrderRow.Fields.ShipCountry);
...
(function (EISPortal) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return EISPortal.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return EISPortal.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return EISPortal.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return EISPortal.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = EISPortal.Northwind.ProductRow.Fields;
...
(function (EISPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(EISPortal.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return EISPortal.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (EISPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(EISPortal.Northwind.OrderDetailsEditor));
...
(function (EISPortal) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return EISPortal.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return EISPortal.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return EISPortal.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return EISPortal.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new EISPortal.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = EISPortal.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(EISPortal.Northwind.OrderDetailDialog));
...
(function (EISPortal) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return EISPortal.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return EISPortal.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return EISPortal.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return EISPortal.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return EISPortal.Northwind.OrderService.baseUrl; };
...
(function (EISPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(EISPortal.Northwind.OrderDialog));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: EISPortal.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: EISPortal.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new EISPortal.Northwind.OrderDialog();
                        ...
                        var chai = EISPortal.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = EISPortal.Northwind.EmployeeRow.getLookup().items
...
(function (EISPortal) {
    ...
    })(Authorization = EISPortal.Authorization || (EISPortal.Authorization = {}));
})(EISPortal || (EISPortal = {}));
var EISPortal;
(function (EISPortal) {
    var Administration;
...
//# sourceMappingURL=EISPortal.Web.js.map